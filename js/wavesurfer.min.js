...
!function (a, b) {
    ...
    return a.create = function (b) {
        ...
        destroy: function () {
            this.isPaused() || this.pause(), this.unAll(), this.buffer = null, this.disconnectFilters(), this.disconnectSource(), this.gainNode.disconnect(), this.scriptNode.disconnect(), this.analyser.disconnect(), this.params.audioContext || "undefined" != typeof this.ac.close() && this.ac.close()
        },
        load: function (a) {
        ...
        createElements: function () {
            ...
            h && (i = 2);
            var j = .5 / this.params.pixelRatio, k = this.width, l = this.params.height * this.params.pixelRatio, m = l * c || 0, n = l / 2, o = b.length / i, p = this.params.barWidth * this.params.pixelRatio, q = Math.max(this.params.pixelRatio, ~~(p / 2)), r = p + q, s = 1;
        ...
        initDrawer: function (a) {
            ...
            h && (i = 2);
            var j = this.width, k = this.params.height * this.params.pixelRatio, l = k * c || 0, m = k / 2, n = b.length / i, o = this.params.barWidth * this.params.pixelRatio, p = Math.max(this.params.pixelRatio, ~~(o / 2)), q = o + p, r = 1;
            if (this.params.normalize) {
                var s = a.util.max(b), t = a.util.min(b);
                r = -t > s ? -t : s
            }
            ...
            var l = this.params.height * this.params.pixelRatio, m = l * c || 0, n = l / 2, o = 1;
            if (this.params.normalize) {
