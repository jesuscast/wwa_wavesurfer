...
!function (a, b) {
    ...
    var c = "error", d = "warn", e = a.getComponent("Component");
    a.Waveform = a.extend(e, {
        constructor: function (a, c) {
            ...
            a = a < 0 ? 0 : a, b = b || a;
            var c = Math.floor(a % 60), d = Math.floor(a / 60 % 60), e = Math.floor(a / 3600), f = Math.floor(b / 60 % 60), g = Math.floor(b / 3600), h = Math.floor(1e3 * (a - c));
    ...
    var f = function () {
        var a = {className: "vjs-waveform", tabIndex: 0};
        return e.prototype.createEl("div", a)
    }, g = {debug: !1, msDisplayMax: 3}, h = function (b) {
        var c = a.mergeOptions(g, b), d = this;
        d.waveform = new a.Waveform(d, {el: f(), options: c}), d.el().appendChild(d.waveform.el())
    };
